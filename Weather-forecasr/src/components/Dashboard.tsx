...
export default function Dashboard(){
  ...
  async function defaultLoc(){
    ...
    return(
        ...
        <input type ='text' className = "h-10 w-1/2 lg:w-1/3 rounded-md" placeholder=" Enter the Location   " onChange={(e)=>{setCity(e.target.value)}}/>
        <input type ='Number' className = "h-10  w-1/2 lg:w-1/3 rounded-md mt-2" placeholder=" Enter the Days of Forecast " onChange={(e)=>{setFore_days(e.target.value)}}/>
